...
class FG_eval 
{
    public:
        ...
        void LoadParams(const std::map<string, double> &params)
        {
            ...
            cout << "\n!![navMPC::FG_eval] FG_eval Obj parameters updated !! " << _mpc_steps << endl; 
        }
        ...
        void operator()(ADvector& fg, const ADvector& vars) 
        {
            ...
            cout << "-----------------------------------------------" <<endl;
            cout << "[navMPC::FG_eval] cost_cte, etheta, velocity: " << cost_cte << ", " << cost_etheta  << ", " << cost_vel << endl;
            ...
            cout << "[navMPC::FG_eval] cost of actuators: " << fg[0] << endl; 
            ...
            cout << "[navMPC::FG_eval] cost of gap: " << fg[0] << endl; 
...
void MPC::LoadParams(const std::map<string, double> &params)
{
    ...
    cout << "\n!! [navMPC::LoadParams] MPC Obj parameters updated !! " << endl; 
}
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) 
{
    ...
    cout << "[navMPC::Solve  ] Cost        :" << cost << std::endl;
    cout << "[navMPC::Solve  ] max_angvel  :" << _max_angvel <<endl;
    cout << "[navMPC::Solve  ] max_throttle:" << _max_throttle <<endl;
    cout << "-----------------------------------------------" <<endl;
